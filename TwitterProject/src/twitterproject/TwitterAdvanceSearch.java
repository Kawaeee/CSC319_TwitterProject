...
public class TwitterAdvanceSearch extends javax.swing.JFrame {
    ...
    public Font getFont() {
        try {
            ...
            Font label4size = font.deriveFont(14f);
            Font label3size = font.deriveFont(16f);
            Font label2size = font.deriveFont(20f);
            jLabel4.setFont(label4size);
            jLabel5.setFont(label4size);
            jLabel6.setFont(label4size);
            jLabel7.setFont(label4size);
            jLabel8.setFont(label4size);
            jLabel12.setFont(label4size);
            jLabel3.setFont(label2size);
            jLabel11.setFont(label4size);
            jLabel13.setFont(label4size);
            jLabel10.setFont(label2size);
